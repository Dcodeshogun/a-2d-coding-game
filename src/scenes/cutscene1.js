export default class TerminalCutscene1 extends Phaser.Scene {
  constructor() {
    super({ key: 'TerminalCutscene1' });
  }
  preload() {
    this.load.image('icon_2b', 'src/ui/2Bicon.png');
    this.load.image('icon_6o', 'src/ui/OP6Oicon.png');
  }
